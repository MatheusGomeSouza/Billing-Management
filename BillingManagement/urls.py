...
urlpatterns = [
    ...
    path('preview/', invoice_views.preview_data, name='preview'),
    path('billing_view/', invoice_views.billing_view, name='billing_view'),
    path('basic/', invoice_views.create_basic, name='basic'),
    path('billing/', invoice_views.create_billing, name='billing'),
    path('itens/<str:billing_id>/', invoice_views.item_form, name='itens'),
    path('post_itens/', invoice_views.create_itens, name='post_itens'),
    path('post_investiment/', invoice_views.create_investiment, name='post_investiment'),
